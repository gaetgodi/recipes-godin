 ...
 *   2.0.0 - Initial versioned release.
 */
                ...
                foreach ($selected_ids as $original_id) {
                    ...
                    if ($original && $can_share) {
                        if ($recipient_is_subscriber) {
                            ...
                            // Grant sharer viewer access to new author's collection
                            grant_viewer_permission($recipient_id, $current_user_id);
                            // Grant new author viewer access to sharer's collection (reciprocal)
                            grant_viewer_permission($current_user_id, $recipient_id);
                        }
                        ...
                        if ($new_id) {
                            ...
                            foreach ($source_categories as $cat) {
                                $existing_cat = get_user_category_by_name($recipient_id, $cat->cat_name);
